...
// TODO: this file should emit a vtable but it doesn't, luckily JKRArchivePri does that and it doesn't cause any issues
...
// This function is currently full off bugs, it doesn't increase the pointer to the file entries,
// and sets the pointer of mData to null before it's sent to free

...
gsDPLoadTextureBlock_4b_Dolphin(0x0B000180, G_IM_FMT_CI, 32, 40, 15, GX_CLAMP, GX_CLAMP, 0, 0),
gsSPNTrianglesInit_5b(
  2, // tri count
  8, 9, 10, // tri0
  8, 10, 11, // tri1
...
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
gsDPLoadTextureBlock_4b_Dolphin(0x0B000400, G_IM_FMT_CI, 16, 8, 15, GX_REPEAT, GX_CLAMP, 0, 0),

...
gsDPLoadTextureBlock_4b_Dolphin(0x0B000140, G_IM_FMT_CI, 32, 16, 15, GX_CLAMP, GX_MIRROR, 0, 0),
...
gsDPLoadTextureBlock_4b_Dolphin(0x0B000240, G_IM_FMT_CI, 32, 8, 15, GX_CLAMP, GX_CLAMP, 0, 0),
...
gsDPLoadTextureBlock_4b_Dolphin(0x0B0002C0, G_IM_FMT_CI, 16, 8, 15, GX_CLAMP, GX_MIRROR, 0, 0),
gsDPSetTileSize(0, 0, 0, 60, 60),
gsSPNTrianglesInit_5b(
  2, // tri count
  23, 24, 25, // tri0
...
gsDPLoadTextureBlock_4b_Dolphin(0x0B000300, G_IM_FMT_CI, 16, 8, 15, GX_CLAMP, GX_CLAMP, 0, 0),
...
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, TEXEL0, PRIMITIVE, 0, COMBINED, 0, 0, 0, 0, COMBINED),
gsDPLoadTextureBlock_4b_Dolphin(0x0B000340, G_IM_FMT_CI, 16, 16, 15, GX_REPEAT, GX_REPEAT, 0, 0),

...
gsDPLoadTextureBlock_4b_Dolphin(0x0B000180, G_IM_FMT_CI, 32, 8, 15, GX_CLAMP, GX_CLAMP, 0, 0),
...
gsDPLoadTextureBlock_4b_Dolphin(0x0B0002C0, G_IM_FMT_CI, 16, 16, 15, GX_MIRROR, GX_REPEAT, 0, 0),
gsSPNTrianglesInit_5b(
  13, // tri count
  13, 14, 15, // tri0
  16, 17, 18, // tri1
...
gsDPLoadTextureBlock_4b_Dolphin(0x0B000380, G_IM_FMT_CI, 32, 16, 15, GX_CLAMP, GX_CLAMP, 0, 0),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
gsSPNTrianglesInit_5b(
  4, // tri count
  23, 24, 25, // tri0
...
gsDPLoadTextureBlock_4b_Dolphin(0x0B0004C0, G_IM_FMT_CI, 32, 24, 15, GX_CLAMP, GX_CLAMP, 0, 0),
gsSPLoadGeometryMode(G_ZBUFFER | G_SHADE | G_CULL_BACK | G_FOG | G_LIGHTING | G_SHADING_SMOOTH),
...
gsDPLoadTextureBlock_4b_Dolphin(0x0B000680, G_IM_FMT_CI, 16, 8, 15, GX_REPEAT, GX_REPEAT, 0, 0),
...
gsDPLoadTextureBlock_4b_Dolphin(0x0B0006C0, G_IM_FMT_CI, 16, 24, 15, GX_CLAMP, GX_CLAMP, 0, 0),
gsSPNTrianglesInit_5b(
  3, // tri count
  13, 14, 15, // tri0
  13, 15, 16, // tri1

...
> ℹ️ We do not support using Windows itself as a development environment. If you're using Windows, please use Docker, or if you prefer to install manually, use Windows Subsystem for Linux.
